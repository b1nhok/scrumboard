...
CREATE TABLE `notes` (
  ...
  `color` enum('red','blue','green') collate utf8_unicode_ci NOT NULL default 'red',
...
INSERT INTO `notes` VALUES(1, 'This is the first note! Add yours from the button above..', 'Martin', 'red', '478x0x1', '2010-01-17 06:30:14');
